...
const TestData = [
    ...
    { id: 3, name: 'Brad', age: 29, movie: 'Superbad', food: 'french fries', DOB: new Date(1988, 5, 3), pets: false, color: 'black', city: 'Greendale'},
    { id: 4, name: 'Susan', age: 29, movie: 'Mean Girls', food: 'spaghetti', DOB: new Date(1988, 3, 5), pets: true, color: 'pink', city: 'Milwaukee'},
];
